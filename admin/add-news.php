...
if(isset($_POST["kategoriya_id"]) && isset($_POST['sarlavxa']) && isset($_POST['q_sarlavxa']) && isset($_POST['bayoni']) && isset($_POST['holati']) && isset($_FILES['photoFile'])) {
  ...
  $sqlText = "INSERT INTO yangiliklar VALUES(null, $kategoriya_id, $foydalanuvchi_id, '$sarlavxa', '$q_sarlavxa', '$bayoni', '$rasm', 0, $vaqt, $holati)";
  if(mysqli_query($conn, $sqlText)) {
    echo "Ma'lumot qo'shildi";
  }else{
    echo "Ma'lumot qo'shishda xatolik.";
  } 
}
    ...
    <div class="container p-5">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="sarlavxa">
            </div>
            <div class="mb-3">
                <label class="form-label">Qisqacha sarlavxa</label>
                <input type="text" class="form-control" name="q_sarlavxa">
            </div>
            <div class="mb-3">
                <label class="form-label">Batafsil</label>
                <textarea name="bayoni" id="" class="form-control" rows="5"></textarea>
            </div>
